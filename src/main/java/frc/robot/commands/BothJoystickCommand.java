...
public class BothJoystickCommand extends CommandBase  
{
    
    public static PneumaticsSubsystem subsystem;
    public BothJoystickCommand(PneumaticsSubsystem sub)
    {
        subsystem = sub;
    ...
    public void execute()
    {   
        RobotContainer.m_pneumaticssubsytem.joystickmove();
    }
